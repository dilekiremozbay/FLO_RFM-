...
# customer_id, recency, frequnecy ve monetary değerlerinin yer aldığı yeni bir rfm
rfm = pd.DataFrame()
...
#'timedelta64[ns] gün olarak tarihi çeviriyor.
rfm=pd.DataFrame()
rfm["customer_id"]=df["master_id"]
...
#müşteri ne kadar önce gelmişsse bizim için o kadar değerli,derecelendirmesi tersten yapılır.
rfm["frequency_score"]=pd.qcut(rfm['frequency'].rank(method="first"),5,labels=[1,2,3,4,5])
#duplicate sınıflar olabilir renk methodunu yazmazsan hata alırsın.ilk bulduğu veriyi atama yapıyor ve hata olmuyor.
